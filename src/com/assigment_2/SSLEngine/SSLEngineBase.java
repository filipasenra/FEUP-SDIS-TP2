...
public abstract class SSLEngineBase {
     ...
     * is applied on {@link SSLEngineClient#myAppData}. It should be initialized using {@link SSLSession#getPacketBufferSize()},
    ...
    protected boolean doHandshake(SocketChannel socketChannel, SSLEngine engine) throws IOException {
        ...
        System.out.print("About to do handshake...");

        SSLEngineResult result;
        HandshakeStatus handshakeStatus;

        // SSLEngineClient's fields myAppData and peerAppData are supposed to be large enough to hold all message data the peer
